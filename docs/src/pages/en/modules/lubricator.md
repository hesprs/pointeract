...
```TypeScript
import { Lubricator, Pointeract, Drag, lubricatorDragPreset as drag } from 'pointeract';
...
- `lubricatorPanPreset`: targets `pan` event
- `lubricatorZoomPreset`: targets `zoom` event
- `lubricatorDragPreset`: targets `drag` event
